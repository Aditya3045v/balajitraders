                ...
                <div className="grid grid-cols-1 gap-16 items-center">
                    ...
                    <div className="flex flex-col gap-6 max-w-3xl animate-fade-in-up">
                        ...
                        <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-full px-4 py-2 w-fit">
                            ...
                            <span className="text-xs md:text-sm font-medium text-green-300 tracking-wide uppercase">North Bihar Super Distributorship</span>
                        </div>

                        {/* Main Headline */}
                        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-white leading-[1.05] drop-shadow-2xl">
                            BALAJI TRADERS<br className="hidden sm:block" />
                        ...
                        <p className="text-lg sm:text-xl text-slate-200 leading-relaxed font-light">
                            Get <span className="font-bold text-white">300 Units Free Electricity</span>.
                            Official vendor for subsidies up to <span className="font-bold text-white">₹78,000</span> for homes in Muzaffarpur, Begusarai & North Bihar.
                        </p>

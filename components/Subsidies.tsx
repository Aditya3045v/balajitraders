            ...
            <div className="max-w-[1440px] mx-auto px-4 md:px-8 relative z-10">
                ...
                <div className="text-center mb-16 max-w-3xl mx-auto">
                    ...
                    <p className="text-lg text-slate-400 leading-relaxed">
                        As an authorized super distributor, Balaji Traders Solar Energy handles the entire subsidy documentation and approval process for you. We ensure you get every rupee of government benefit you are entitled to.
                    </p>
                </div>
